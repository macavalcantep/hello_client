...
public class Configure extends JFrame {
	...
	private File dirDir = new File("C:\\hello");
	private File dirDb = new File("C:\\hello\\hello.db");
	...
	public Configure() {
		...
		btnInstall.setBounds(427, 260, 117, 25);
		...
		textField_serverPass.setBounds(200, 169, 240, 24);
		...
		btnCancelar.setBounds(298, 260, 117, 25);
		contentPane.add(btnCancelar);

		JLabel lblVersion = new JLabel("Versão");
		lblVersion.setFont(new Font("Calibri", Font.PLAIN, 11));
		lblVersion.setBounds(23, 294, 154, 15);
		contentPane.add(lblVersion);
		lblVersion.setText("Windows - Versão: 1.0.190424");
	}
}
